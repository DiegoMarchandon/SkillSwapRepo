...
export default function PixelDNI({
  u,
  onSubmitProfile,
  setU,
  fieldErrs,
  ...
  return (
    <div className="flex flex-col justify-center items-center w-full">
      <motion.form
        ...
        style={{ rotateX, rotateY, fontFamily: 'VT323', letterSpacing: '1px', fontSize: '18px' }}
      ...
      >
        ...
        <div className="relative z-10 col-span-2 flex gap-3">
          ...
          <div className="flex flex-col justify-center text-[#111] flex-1">
            ...
            <input
              className="w-full rounded-none border border-[#000] bg-[#e0ffe0] p-1 shadow-[2px_2px_0_#000] focus:outline-none focus:bg-[#fff]"
              value={u.name}
        ...
        <div className="relative z-10 col-span-2 mt-2 flex items-center justify-between gap-3">
          ...
          <div className="flex gap-2">
            <button
              type="button"
              onClick={onRestore}
              className="px-3 py-1 bg-gray-400 border-2 border-[#000] shadow-[2px_2px_0_#000] hover:bg-[#baabab] active:shadow-none"
            >
              Restaurar
            </button>
            <button
              ...
              className={`px-3 py-1 bg-[#66a366] border-2 border-[#000] shadow-[2px_2px_0_#000] 
                          text-white hover:bg-[#77b377] active:shadow-none ${saving ? 'opacity-60' : ''}`}
            >
