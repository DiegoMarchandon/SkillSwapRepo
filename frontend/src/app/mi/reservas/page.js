...
export default function MisReservasPage() {
  ...
  // const puedeCancelar = useState(false);
  ...
  // Función para abrir el modal de rating
  ...
  async function enviarResena() {
    ...
    try {
      ...
      setRatingModal(null);
      await load(); // Recargar para actualizar el estado
    } catch (e) {
        ...
        <table className="min-w-full text-sm">
          ...
          <tbody>
            ...
            {!loading && rows.map(r => {
              ...
              const tieneResena = r.resena_existente; // Asumiendo que la API devuelve esto
